...
package com.blu3f1re.reddwallet.service;
...
import com.google.reddcoin.net.discovery.*;
...
import com.google.reddcoin.core.BlockChain;
import com.google.reddcoin.core.CheckpointManager;
import com.google.reddcoin.core.Peer;
import com.google.reddcoin.core.PeerEventListener;
import com.google.reddcoin.core.PeerGroup;
import com.google.reddcoin.core.ScriptException;
...
import com.blu3f1re.reddwallet.WalletBalanceWidgetProvider;
import com.blu3f1re.reddwallet.ui.WalletActivity;
import com.blu3f1re.reddwallet.util.CrashReporter;
import com.blu3f1re.reddwallet.util.GenericUtils;
import com.blu3f1re.reddwallet.util.ThrottlingWalletChangeListener;
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				peerGroup.addPeerDiscovery(new PeerDiscovery()
				{
                    ...
                    String channel = "#reddcoin" + String.format("%02d", i);
