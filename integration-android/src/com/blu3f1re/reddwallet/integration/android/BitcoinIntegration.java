...
package com.blu3f1re.reddwallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("reddcoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Dogecoin application found.\nPlease install Dogecoin Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.blu3f1re.reddwallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://langerhans.github.io/reddcoin-wallet-new/"));
